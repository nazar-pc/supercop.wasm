...
if("function"!==typeof b.locateFile){if(b.memoryInitializerPrefixURL||b.pthreadMainPrefixURL||b.cdInitializerPrefixURL||b.filePackagePrefixURL)throw Error("Module['locateFile'] can't be used together with Module['*PrefixURL'] options; if you need to customize prefix, take a look at Module['scriptDirectory'] option instead");b.scriptDirectory||(b.scriptDirectory=q?__dirname+"/":n?document.currentScript.src.split("/").slice(0,-1).join("/")+"/":p?self.location.href.split("/").slice(0,-1).join("/")+"/":
"");b.locateFile=function(a){return b.scriptDirectory+a}}
...
b.p={abort:H,assert:assert,enlargeMemory:function(){F()},getTotalMemory:function(){return E},abortOnCannotGrowMemory:F,___setErrNo:function(a){b.___errno_location&&(B[b.___errno_location()>>2]=a);return a},DYNAMICTOP_PTR:D,tempDoublePtr:Aa,ABORT:G,STACKTOP:y,STACK_MAX:S};var Ba=b.asm(b.o,b.p,buffer);b.asm=Ba;var N=b._malloc=function(){return b.asm._malloc.apply(null,arguments)};b.getTempRet0=function(){return b.asm.getTempRet0.apply(null,arguments)};
...
b.stackAlloc=function(){return b.asm.stackAlloc.apply(null,arguments)};z.l=b.stackAlloc;z.w=b.stackSave;z.v=b.stackRestore;z.G=b.establishStackSpace;z.u=b.setTempRet0;z.s=b.getTempRet0;b.asm=Ba;
if(Z)if(Z=b.memoryInitializerPrefixURL?b.memoryInitializerPrefixURL+Z:b.locateFile(Z),q||t){var Ca=b.readBinary(Z);O.set(Ca,z.d)}else{var Ea=function(){b.readAsync(Z,Da,function(){throw"could not load memory initializer "+Z;})};ya();var Da=function(a){a.byteLength&&(a=new Uint8Array(a));O.set(a,z.d);b.memoryInitializerRequest&&delete b.memoryInitializerRequest.response;za()};if(b.memoryInitializerRequest){var Fa=function(){var a=b.memoryInitializerRequest;200!==a.status&&0!==a.status?(console.warn("a problem seems to have happened with Module.memoryInitializerRequest, status: "+
a.status+", retrying "+Z),Ea()):Da(a.response)};b.memoryInitializerRequest.response?setTimeout(Fa,0):b.memoryInitializerRequest.addEventListener("load",Fa)}else Ea()}b.then=function(a){if(b.calledRun)a(b);else{var c=b.onRuntimeInitialized;b.onRuntimeInitialized=function(){c&&c();a(b)}}return b};function x(a){this.name="ExitStatus";this.message="Program terminated with exit("+a+")";this.status=a}x.prototype=Error();x.prototype.constructor=x;
var Ga=null,Y=function Ha(){b.calledRun||Ia();b.calledRun||(Y=Ha)};b.callMain=b.C=function(a){function c(){for(var a=0;3>a;a++)e.push(0)}a=a||[];V||(V=!0,U(qa));var d=a.length+1,e=[M(va(b.thisProgram),"i8",0)];c();for(var h=0;h<d-1;h+=1)e.push(M(va(a[h]),"i8",0)),c();e.push(0);e=M(e,"i32",0);try{var f=b._main(d,e,0);Ja(f,!0)}catch(k){k instanceof x||("SimulateInfiniteLoop"==k?b.noExitRuntime=!0:((a=k)&&"object"===typeof k&&k.stack&&(a=[k,k.stack]),b.c("exception thrown: "+a),b.quit(1,k)))}finally{}};
function Ia(a){function c(){if(!b.calledRun&&(b.calledRun=!0,!G)){V||(V=!0,U(qa));U(ra);if(b.onRuntimeInitialized)b.onRuntimeInitialized();b._main&&Ka&&b.callMain(a);if(b.postRun)for("function"==typeof b.postRun&&(b.postRun=[b.postRun]);b.postRun.length;){var c=b.postRun.shift();ta.unshift(c)}U(ta)}}a=a||b.arguments;null===Ga&&(Ga=Date.now());if(!(0<X)){if(b.preRun)for("function"==typeof b.preRun&&(b.preRun=[b.preRun]);b.preRun.length;)ua();U(pa);0<X||b.calledRun||(b.setStatus?(b.setStatus("Running..."),
setTimeout(function(){setTimeout(function(){b.setStatus("")},1);c()},1)):c())}}b.run=b.run=Ia;function Ja(a,c){if(!c||!b.noExitRuntime){if(!b.noExitRuntime&&(G=!0,y=void 0,U(sa),b.onExit))b.onExit(a);q&&process.exit(a);b.quit(a,new x(a))}}b.exit=b.exit=Ja;var La=[];
